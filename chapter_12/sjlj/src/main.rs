...
type jmp_buff = [i8; JMP_BUF_WIDTH];

static mut SHUT_DOWN: bool = false;
static mut RETURN_HERE: jump_buf = [0; JMP_BUF_WIDTH];
...
extern "C" {
    ...
    pub fn longjmp(_: *mut i8) -> i32;
}

#[inline]
fn ptr_to_jmp_buff() -> *mut i8 {
    unsafe { &RETURN_HERE as *const i8 as *mut i8 }
}

#[inline]
fn return_early() {
    let franken_pointer = ptr_to_jmp_bug();
